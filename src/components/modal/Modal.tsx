...
export default function Modal() {
    ...
    useEffect(() => {
        console.log("Modal Intranet Credsudeste");
        function visibibleModal() {
            // window.localStorage.setItem("isVisibleModal", isVisible);
            if (window.location.href === "https://crediminas.sharepoint.com/sites/credisudeste" && isVisibleModal) {
        ...
        function getInfoForModal() {
            axios.get("https://crediminas.sharepoint.com/sites/credisudeste/_api/web/lists/getbytitle('Informações Modal')/items?$top=1&$orderby=ID desc")
                .then((result) => {
